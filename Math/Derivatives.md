...
$$
> OBS.: Uma função se torna diferenciável quando se é possivel calcula a derivada para um determinado valor de x;

> OBS.: O resultado de uma derivada permite que seja calculado o coeficiente angular das retas tangentes aos pontos da função que foi derivada;
